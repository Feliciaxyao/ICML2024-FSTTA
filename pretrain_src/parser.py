...
def load_parser():
    ...
    parser.add_argument(
        "--model_config",default='config/reverie_obj_model_config.json', type=str, help="path to model structure config json",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir",
        default='../datasets/REVERIE/exprs_map/pretrain/cmt-vitbase-mlm.mrc.sap.og-init.lxmert-aug.speaker',
        type=str,
    ...
    parser.add_argument("--config", default='config/reverie_obj_pretrain.json', help="JSON config files",)
